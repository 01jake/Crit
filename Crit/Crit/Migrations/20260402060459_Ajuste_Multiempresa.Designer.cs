...
namespace Crit.Migrations
{
    ...
    [Migration("20260402060459_Ajuste_Multiempresa")]
    partial class Ajuste_Multiempresa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crit.Shared.Models.CajaSesion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Crit.Shared.Models.Empresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Crit.Shared.Models.Gasto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CajaMovimientoId")
                        .HasColumnType("int");

                    b.Property<int?>("CajaMovimientoId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Crit.Shared.Models.InventarioPorAlmacen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InventarioPorAlmacen");
                });

            modelBuilder.Entity("Crit.Shared.Models.MovimientoInventario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Crit.Shared.Models.OrdenReabastecimiento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("CantidadSugerida")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int?>("TraspasoAlmacenId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TraspasoAlmacenId");

                    b.ToTable("OrdenesReabastecimiento");
                });
            ...
            modelBuilder.Entity("Crit.Shared.Models.Proveedor", b =>
                {
                    ...
                    b.HasIndex("Email", "EmpresaId")
                        .IsUnique()
                        .HasFilter("[Email] IS NOT NULL AND [EmpresaId] IS NOT NULL");
            ...
            modelBuilder.Entity("Crit.Shared.Models.TraspasoAlmacen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Crit.Shared.Models.UbicacionAlmacen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Crit.Shared.Models.Compra", b =>
                {
                    b.HasOne("Crit.Shared.Models.Almacen", "Almacen")
                        .WithMany()
            ...
            modelBuilder.Entity("Crit.Shared.Models.Gasto", b =>
                {
                    b.HasOne("Crit.Shared.Models.CajaMovimiento", "CajaMovimiento")
                        .WithMany()
                        .HasForeignKey("CajaMovimientoId1");
            ...
            modelBuilder.Entity("Crit.Shared.Models.InventarioPorAlmacen", b =>
                {
                    ...
                    b.HasOne("Crit.Shared.Models.UbicacionAlmacen", "UbicacionAlmacen")
                        .WithMany()
            ...
            modelBuilder.Entity("Crit.Shared.Models.OrdenReabastecimiento", b =>
                {
                    ...
                    b.HasOne("Crit.Shared.Models.TraspasoAlmacen", "TraspasoAlmacen")
                        .WithMany()
                        .HasForeignKey("TraspasoAlmacenId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Crit.Shared.Models.TraspasoAlmacen", b =>
                {
                    b.HasOne("Crit.Shared.Models.Almacen", "AlmacenDestino")
                        .WithMany()
                        .HasForeignKey("AlmacenDestinoId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Crit.Shared.Models.Almacen", "AlmacenOrigen")
                        .WithMany()
